...
var stefanvdurl = "https://addons.mozilla.org/firefox/addon/turn-off-the-lights/";var stefanvdaacodeurl = encodeURIComponent(stefanvdurl);
...
// Download Upgrade
$("fndownload").addEventListener('click', function() {window.open("https://addons.mozilla.org/firefox/addon/finance-toolbar/");});
$("ppdownload").addEventListener('click', function() {window.open("https://addons.mozilla.org/firefox/addon/proper-menubar/");});
$("zodownload").addEventListener('click', function() {window.open("http://www.stefanvd.net/project/zoom.htm");});
$("aadownload").addEventListener('click', function() {window.open("https://addons.mozilla.org/firefox/addon/ambient-aurea/");});

$("themedownload").addEventListener('click', function() {window.open("https://addons.mozilla.org/firefox/addon/turn-off-the-lights-theme/");});
...
// Review box
$("war").addEventListener('click', function() {window.open("https://addons.mozilla.org/firefox/addon/turn-off-the-lights/", "_blank");$("sectionreviewbox").style.display = "none";prefManager.setCharPref("extensions.TurnOfftheLights.reviewedlastonversion", $("version_number").textContent);});
$("nt").addEventListener('click', function() {$("sectionreviewbox").style.display = "none";prefManager.setCharPref("extensions.TurnOfftheLights.reviewedlastonversion", $("version_number").textContent);});
